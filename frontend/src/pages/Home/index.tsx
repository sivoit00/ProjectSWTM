...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen p-8 overflow-y-auto bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-white">
      <div className="max-w-4xl w-full space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-xl p-6 hover:border-blue-500/40 transition dark:bg-blue-900/30 dark:backdrop-blur-sm dark:border-blue-500/20">
