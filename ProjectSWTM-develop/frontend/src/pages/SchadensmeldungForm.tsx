...
export default function SchadensmeldungForm() {
      ...
      <div className="flex-1 ml-64 p-8">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white">Schadensmeldung</h1>
              <p className="text-gray-400">
                Melden Sie einen Schaden an Ihrem Fahrzeug
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              Das Schadensmeldungs-Formular wird in einer zukünftigen Version
              implementiert.
            </p>
