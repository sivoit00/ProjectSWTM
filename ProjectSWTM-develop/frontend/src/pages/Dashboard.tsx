      ...
      <div className="flex-1 ml-64 p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="space-y-3">
              <button className="w-full text-left p-3 bg-blue-600 hover:bg-blue-700 rounded-lg transition text-white font-medium">
                + Neuen Auftrag erstellen
              </button>
              <button className="w-full text-left p-3 bg-slate-800 hover:bg-slate-700 rounded-lg transition text-white font-medium">
